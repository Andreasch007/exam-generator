...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="{{ backpack_url('login') }}">Login / Register</a></li>
                    </ul>
                </div>
            </div>
        </nav>
                ...
                <div class="row h-100">
                    <div class="col-lg-7 my-auto">
                        <div class="header-content mx-auto">
                            ...
                            <a class="btn btn-outline-light py-3 px-4 rounded-pill js-scroll-trigger" href="#download">Start Now for Free!</a>
                        </div>
                    </div>
        ...
        <section class="cta">
            <div class="cta-content">
                <div class="container">
                    ...
                    <a class="btn btn-outline-light py-3 px-4 rounded-pill js-scroll-trigger" href="#contact">Let's Get Started!</a>
                </div>
            </div>
        ...
        <section class="contact bg-primary" id="contact">
            ...
            <button onclick="topFunction()" id="myBtn" title="Go to top" class="icon-chevron-up"></button>
