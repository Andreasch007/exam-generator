...
<div class="container-repeatable-elements">
  ...
  <button type="button" class="btn btn-outline-primary btn-sm ml-1 add-repeatable-element-button" id="add-service-button">+ {{ $field['new_item_label'] ?? trans('backpack::crud.new_item') }}</button>
